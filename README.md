# Kasm Unigen Heaven Benchmork
Unigen Heaven Benchmark docker image for Kasm Workspaces (https://kasmweb.com)
...
## Build
```bash
sudo docker build -t unigen-heaven:latest -f Dockerfile .
```